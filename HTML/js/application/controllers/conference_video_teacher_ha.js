 ...
 */
conferenceAppModule.controller('conferenceTeacherControllerHa', ['$rootScope', '$scope', '$http', '$interval', '$location', '$window', 'AppConstants',
    function ($rootScope, $scope, $http, $interval, $location, $window, AppConstants) {
        ...
        $(document).ready(function () {
            ...
            var conferenceId = "12223deb1ff9ade9";
            ...
            //client.guestLoginWithOptions(conference_guest.name, conferenceId, conferenceUrl, function (loginStatus) {
                ...
                //client.guestLogin(conference_guest.name, "98c9ca76299b7af9", function (loginStatus) {
                client.guestLoginWithOptions(conference_guest.name, "12223deb1ff9ade9", "/guest.html?conferenceId=12223deb1ff9ade9&audio=1&video=1&dialout=0&moderator=1&c=e3f80943c706303e", function (loginStatus) {
