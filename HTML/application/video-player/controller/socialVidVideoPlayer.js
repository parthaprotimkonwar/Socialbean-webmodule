 ...
 */
videoApp.controller('socialVidVideoPlayer', ['$routeParams','$rootScope', '$scope', '$http', '$interval', '$location', '$window', 'AppConstants',
    function ($routeParams, $rootScope, $scope, $http, $interval, $location, $window, AppConstants) {
...
// var app2;
        ...
        var callback = function(evt) {
            ...
            //alert(url);
            var url = "https://nstl.socialvid.in/videos/" + $routeParams.videoId + "/" + $routeParams.conferenceId + "/master.json";
            ...
            app = new WebRtcPlayer(url, g("webrtcPlayerContainer"), callback);
